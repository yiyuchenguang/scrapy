...
browser.get("https://so.gushiwen.cn/gushi/tangshi.aspx")
print(browser.implicitly_wait(3))
...
browser.get("https://so.gushiwen.cn/shiwenv_3963afd966bc.aspx")
son = browser.find_element_by_xpath(".//div[@class='sons']")
if son:
    ...
    yi_button = son.find_element_by_xpath("//div[@class = 'cont']//div[@class = 'yizhu']//img[contains(@alt,'译')]")
    yi_button.click()
    time.sleep(0.2)
    ...
    zhu_button = son.find_element_by_xpath("//div[@class = 'cont']//div[@class = 'yizhu']//img[contains(@alt,'注')]")
    zhu_button.click()
    time.sleep(0.2)
    ...
    shang_button = son.find_element_by_xpath("//div[@class = 'cont']//div[@class = 'yizhu']//img[contains(@alt,'赏')]")
    shang_button.click()
    time.sleep(0.5)

    shang = son.find_elements_by_xpath(".//div[@class = 'cont']//div[@class = 'contson']//div[@class = 'hr']/following-sibling::p[not(@style)]")
